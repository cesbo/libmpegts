...
#[test]
fn test_psi_assemble_on_ts_no_psi() {
    static TS_NO_PAYLOAD: &[u8] = &[
    ...
    let mut packets = TS_NO_PAYLOAD.ts_packets();
...
#[test]
fn test_psi_assemble_invalid_pointer_field() {
    static TS_INVALID: &[u8] = &[
    ...
    let mut psi = Psi::default();
    let mut packets = TS_INVALID.ts_packets();
    let first_ts = packets.next().expect("first TS expected");
    assert!(psi.assemble(&first_ts).is_none());
    assert!(psi.payload().is_none());
}
...
#[test]
fn test_psi_assemble_one_ts_one_psi() {
...
#[test]
fn test_psi_assemble_two_ts_one_psi() {
...
#[test]
fn test_psi_assemble_two_ts_two_psi() {
