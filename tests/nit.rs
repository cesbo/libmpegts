...
fn test_assemble_nit() {
    ...
    let data: &[(u16, u16, &[Vec<u8>])] = &[
        (
            ...
            &[
                vec![
                    0x43, 0x01, 0x23, 0x80, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03,
                ],
        ...
        (
            ...
            318,
            &[vec![
                0x43, 0x01, 0x10, 0x34, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03,
            ]],
        ),
        (
            700,
            318,
            &[vec![
                0x43, 0x01, 0x13, 0x17, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03,
            ]],
        ),
        (
            8900,
            318,
            &[vec![
                0x43, 0x01, 0x24, 0x76, 0x00, 0x01, 0x30, 0x86, 0x02, 0x99, 0x00, 0x03,
            ]],
        ),
        (
            9400,
            318,
            &[vec![
                0x43, 0x01, 0x25, 0x97, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03,
            ]],
        ),
        (
            15600,
            318,
            &[vec![
                0x43, 0x01, 0x16, 0x23, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03,
            ]],
        ),
    ];
