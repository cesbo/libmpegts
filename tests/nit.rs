...
fn test_assemble_nit() {
    ...
    let data: &[(u16, u16, &[Vec<u8>])] = &[
        (
            ...
            318,
            &[
                vec![0x43, 0x0b, 0x01, 0x23, 0x80, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03],
                vec![0x83, 0x04, 0x0b, 0xc6, 0xc0, 0x2d]
            ]
        ),
        (
            12600,
            318,
            &[
                vec![0x43, 0x0b, 0x01, 0x10, 0x34, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03]
            ]
        ),
        (
            700,
            318,
            &[
                vec![0x43, 0x0b, 0x01, 0x13, 0x17, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03]
            ]
        ),
        (
            8900,
            318,
            &[
                vec![0x43, 0x0b, 0x01, 0x24, 0x76, 0x00, 0x01, 0x30, 0x86, 0x02, 0x99, 0x00, 0x03]
            ]
        ),
        (
            9400,
            318,
            &[
                vec![0x43, 0x0b, 0x01, 0x25, 0x97, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03]
            ]
        ),
        (
            15600,
            318,
            &[
                vec![0x43, 0x0b, 0x01, 0x16, 0x23, 0x00, 0x01, 0x30, 0xa1, 0x02, 0x75, 0x00, 0x03]
            ]
        ),
    ];
    ...
    for (tsid, onid, descs) in data.iter() {
        ...
        for desc in descs.iter() {
            item.descriptors.push(Descriptor::DescRaw(desc.clone()));
        }
